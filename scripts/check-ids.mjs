...
// app — both were already outside the original, app.js-only version of this
// check; excluded explicitly now so growing the scan to every module
// doesn't silently pull them back in.
